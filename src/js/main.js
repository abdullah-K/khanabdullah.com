...
document.addEventListener("DOMContentLoaded", () => {
	console.log(
		"%c Hey there! You can look at this website's source code on https://github.com/abdlkhn/khanabdullah.com",
		"background: #1B498C; color: #fff;"
	);

	// section height adjustment for mobile
	if (/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)) {
		let vh = window.matchMedia("(orientation: landscape)").matches
